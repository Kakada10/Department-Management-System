...
export default function AddSession() {
  ...
  let currentPath = window.location.pathname.substr(20);
  ...
  const onSubmit = () =>{
    ...
    axios.post("http://localhost:3000/teacher/create/assignment",{name: inputText,desc: inputDesc, course_id: currentPath, start: fromTime, end:toTime , date: date, group: inputGroup},{ withCredentials: true })
      .then((result) => {
        alert("Sessions Created Successfully!!");
        window.location.replace("/course/session-list/"+currentPath)
        })
