...
export default function Schedule() {
  ...
  const handleSubmit = async () => {
    ...
    setRoom63('')
    setRoom64('')
    await axios.post("http://localhost:3000/getSchedule",{year: year,from: inputFromYear,to: inputToYear,semester:semester,group: group},{ withCredentials: true })
    .then((result) => {
  ...
  return(
        <div>
            <Box templateColumns="repeat(6,1fr)" sx={{ flexGrow: 1, display: { xs: 'none', md: 'flex' }, mt: 2, mb: 2 , ml:2 }}>
              <Stack>
              ...
              <Stack>
                <FormControl sx={{ width: '250px', marginRight:'10px',  marginLeft:'10px'}}>
                    <SELECT_OPTIONS
              ...
              <Stack>
                <Button
                  ...
                  variant="solid"
                  style={{position:"absolute", right:'15px', backgroundColor: '#779ecc'}}
