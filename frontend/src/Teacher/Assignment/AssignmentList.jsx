    ...
    <Box component="div">
      ...
      <Box mt="20px" ml="30px">
        ...
        >
          ...
          <Typography
            level="h2"
            sx={{ fontSize: 'md', fontWeight: 'bold', ml:2, mt: 2, mb: 2 }}
          >
            {course.course_name}
          </Typography>
          ...
          <div>
            ...
            >
               <Link
                ...
                to={`/teacher/course/add_assignment/${course.course_id}`}
              >
            ...
            >
              <CardActions>
                ...
                >
                  <Link
                    style={{ textDecoration: 'none', color: 'black' }}
                    to={`/teacher/course/view_assignment/${assignment._id}`}
                  >
                    <p>View Assignment</p>
                  </Link>
                </Button>
